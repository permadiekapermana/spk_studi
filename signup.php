     ...
     <td><form name="form1" method="post" action="signupuser.php" onSubmit="return check();">
       <table width="301" border="0" align="left">
         <tr>
          ...
          $pel="USER.";
          $y=substr($pel,0,4);
          $query=mysql_query("select * from mst_user where substr(user_id,1,4)='$y' order by user_id desc limit 0,1");
          $row=mysql_num_rows($query);
          $data=mysql_fetch_array($query);
          if ($row>0){
          $no=substr($data['user_id'],-6)+1;}
          else{
          $no=1;
          }
          $nourut=1000000+$no;
          ...
          echo"
           <td><input type='hidden' value='$nopel' name='user_id'></td>
          ";
          ?>
         </tr>
         <tr>
         ...
         <tr>
           <td valign="top" class="style7">Date of Birth</td>
         ...
         <tr>
           <td>&nbsp;</td>
           <td><input type="submit" name="Submit" value="Signup"><button type='button' onclick=self.history.back()>Cancel</button>
           </td>
         </tr>
       </table>
     </form></td>
