...
{
  $password     = md5($pass);
	$rs=mysql_query("select * from mst_user where username='$loginid' and pass='$password'");
...
<table width="100%" border="0">
  ...
  <tr>
    <td height="296" valign="top"><div align="center">
        <h1 class="style8">Sistem Pendukung Keputusan Pemilihan Program Studi Bagi Anak SMA Metode Differential Aptitude Test (DAT)</h1>
...
<p align="left" class="style5">&nbsp;</p>
      <blockquote>
          <p align="left" class="style5"><span class="style7">Selamat Datang. Disini kalian harus mengerjakan tes DAT terlebih dahulu untuk mengetahui jurusan apa yang cocok</span></p>
      </blockquote>
    </div></td>
